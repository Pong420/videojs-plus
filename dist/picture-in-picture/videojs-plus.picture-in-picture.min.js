(function (videojs) {
  ...
  videojs__default.pipPlayer = null;

  var pictureInPicture =
  /*#__PURE__*/
  function (_getPlugin) {
    _inheritsLoose(pictureInPicture, _getPlugin);
    ...
    function pictureInPicture(player, options) {
      ...
      _this2 = _getPlugin.call(this, player, options) || this;
      _this2.cache_ = {};
    ...
    _proto.createPipPlayer = function createPipPlayer() {
      ...
      var pipPlayer = videojs__default.pipPlayer = videojs__default(videoEl, pipPlayerOptions);
    ...
    _proto.handleOriginPlayer = function handleOriginPlayer() {
      ...
      parentPlayer.one('loadstart', function () {
    ...
    _proto.exit = function exit() {
      ...
      var pipPlayer = videojs__default.pipPlayer;
    ...
    _proto.dispose = function dispose() {
      _getPlugin.prototype.dispose.call(this);
    ...
    _proto.draggable = function draggable(el) {
      ...
      videojs__default.pipPlayer.on('dispose', function () {
