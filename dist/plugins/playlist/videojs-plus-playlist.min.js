...
(function (video_js) {
  ...
  video_js.registerComponent("PlayNextSpinner", PlayNextSpinner);
  ...
  function (_Component) {
    ...
    function BeforePlayNextLayer(player, options) {
      ...
      var dispose = _this2.dispose.bind(_assertThisInitialized(_assertThisInitialized(_this2)));
    ...
    _proto.createEl = function createEl() {
      ...
      var el = video_js.dom.createEl("div", {
  ...
  video_js.registerPlugin("playNext", playNext);
  video_js.registerComponent("BeforePlayNextLayer", BeforePlayNextLayer);

  var SettingMenuButton = video_js.getComponent("SettingMenuButton");
  var SettingOnOffItem = video_js.getComponent("SettingOnOffItem");
  ...
  function (_SettingOnOffItem) {
    ...
    function ToggleAutoPlayNext(player, options) {
      var _this;
  ...
  video_js.registerComponent("ToggleAutoPlayNext", ToggleAutoPlayNext);
  ...
  function (_Button) {
    ...
    function PrevNextButton(player, options) {
      ...
      player.on("playlist", _this.updateVisibility.bind(_assertThisInitialized(_assertThisInitialized(_this))));
      return _this;
    }
  ...
  video_js.registerComponent("PrevNextButton", PrevNextButton);
  ...
  video_js.registerComponent("CancelPlayNextEl", CancelPlayNextEl);
  ...
  function (_List) {
    ...
    _proto.play = function play(index) {
      ...
      player.src(sources);
      player.title(title || "");
      player.trigger("playlistchange", Object.assign(this.current(), {
        index: this.index()
      }));
    };
  ...
  video_js.registerPlugin("setPlayList", function (playlist) {
    var player = this.player_;
